...
class App:
    def __init__(self, root):
        ...
        tk.Button(self.button_frame, text="Submit",
                  command=self.submit_data).grid(row=0, column=0, padx=5)
    ...
    def close_browser(self):
        ...
        messagebox.showinfo("Browser Close", "Submitted Succesfully")
